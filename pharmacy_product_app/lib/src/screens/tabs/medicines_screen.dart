    ...
    List<Widget> filterChips = _categories.map((category) {
      ...
      return Padding(
        ...
        child: FilterChip(
          ...
          selectedColor: Colors.blue, // Theme color for Medicines
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text('\$${product.price.toStringAsFixed(2)}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue)),
