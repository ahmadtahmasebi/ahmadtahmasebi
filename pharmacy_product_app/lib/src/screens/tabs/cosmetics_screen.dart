...
class _CosmeticsScreenState extends State<CosmeticsScreen> {
  ...
  final String _tabMasterType = 'cosmetics';
  ...
  Widget _buildProductDisplay() {
    if (_selectedCategoryId != null) {
      ...
      if (_displayCategories.isEmpty) {
         return Center(child: Padding(padding: const EdgeInsets.all(16.0), child: Text("هیچ دسته‌بندی برای بخش آرایشی تعریف نشده است.", textAlign: TextAlign.center)));
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("آرایشی")),
      body: Column(
        children: [
