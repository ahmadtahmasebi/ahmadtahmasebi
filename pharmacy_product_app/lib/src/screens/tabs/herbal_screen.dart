...
class _HerbalScreenState extends State<HerbalScreen> {
  ...
  final String _tabMasterType = 'herbal';
  ...
  Widget _buildProductDisplay() {
    if (_selectedCategoryId != null) {
      ...
      if (_displayCategories.isEmpty) {
         return Center(child: Padding(padding: const EdgeInsets.all(16.0), child: Text("هیچ دسته‌بندی برای بخش گیاهی تعریف نشده است.", textAlign: TextAlign.center)));
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("گیاهی")),
      body: Column(
        children: [
