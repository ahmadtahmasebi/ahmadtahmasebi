...
class _SupplementsScreenState extends State<SupplementsScreen> {
  ...
  final String _tabMasterType = 'supplements';
  ...
  Widget _buildProductDisplay() {
    if (_selectedCategoryId != null) {
      ...
      if (_displayCategories.isEmpty) {
         return Center(child: Padding(padding: const EdgeInsets.all(16.0), child: Text("هیچ دسته‌بندی برای بخش مکمل‌ها تعریف نشده است.", textAlign: TextAlign.center)));
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("مکمل ها")),
      body: Column(
        children: [
