...
class _SupplementsScreenState extends State<SupplementsScreen> {
    ...
    List<Widget> filterChips = _categories.map((category) {
      ...
      return Padding(
        ...
        child: FilterChip(
          ...
          selectedColor: Colors.orange, // Theme color for Supplements
    ...
    filterChips.insert(
      ...
      Padding(
        ...
        child: FilterChip(
          ...
          backgroundColor: _selectedCategoryId == null ? Colors.orange[100] : Colors.grey[200],
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text('\$${product.price.toStringAsFixed(2)}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.orange)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('مکمل ها (Supplements)'),
